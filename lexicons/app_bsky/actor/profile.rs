...
pub struct Profile<'a> {
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub joined_via_starter_pack: Option<jacquard_common::types::value::Data<'a>>,
    /// Self-label values, specific to the Bluesky application, on the overall account.
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub labels: Option<jacquard_common::types::value::Data<'a>>,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub pinned_post: Option<jacquard_common::types::value::Data<'a>>,
